...
def test05_condominio():
    ...
    chrome_driver.save_screenshot('..\Screenshot\CP05\Inicio_Sesion.png')
    ...
    chrome_driver.save_screenshot('..\Screenshot\CP05\Home_Sistema.png')
    ...
    RutCondominio = sheet['B6'].value
    RazonSocial = sheet['C6'].value
    NroReserva = sheet['D6'].value
    CONSORCIO = sheet['E6'].value
    CHUBB = sheet['F6'].value
    Renta = sheet['G6'].value
    Comuna = sheet['H6'].value
    Direccion = sheet['I6'].value
    ConstruccionMuro = sheet['J6'].value
    ConstTecho = sheet['K6'].value
    TipoCondominio = sheet['L6'].value
    NPisos = sheet['M6'].value
    NSubterraneos = sheet['N6'].value
    Antiguedad = sheet['O6'].value
    UbicacionRiesgo = sheet['P6'].value
    BienesEspacio = sheet['Q6'].value
    MontoDPTO = sheet['R6'].value
    NUnidad = sheet['S6'].value
    Trabajadores = sheet['T6'].value
    FormaPago = sheet['V6'].value
    NCuotas = sheet['W6'].value
    ...
    chrome_driver.find_element_by_xpath('//*[@id="ui-id-2"]').click()
    sleep(1)
    chrome_driver.save_screenshot('..\Screenshot\CP05\Parte01_FormularioCondominio.png')
    ...
    chrome_driver.save_screenshot('..\Screenshot\CP05\Parte02_FormularioCondominio.png')
