...
def test09_condominio():
    ...
    chrome_driver.save_screenshot('..\Screenshot\CP09\Inicio_Sesion.png')
    ...
    chrome_driver.save_screenshot('..\Screenshot\CP09\Home_Sistema.png')
    ...
    RutCondominio = sheet['B10'].value
    RazonSocial = sheet['C10'].value
    NroReserva = sheet['D10'].value
    CONSORCIO = sheet['E10'].value
    CHUBB = sheet['F10'].value
    Renta = sheet['G10'].value
    Direccion = sheet['I10'].value
    ConstruccionMuro = sheet['J10'].value
    ConstTecho = sheet['K10'].value
    TipoCondominio = sheet['L10'].value
    NPisos = sheet['M10'].value
    NSubterraneos = sheet['N10'].value
    BienesEspacio = sheet['Q10'].value
    MontoDPTO = sheet['R10'].value
    NUnidad = sheet['S10'].value
    NTrabajadores = sheet['T10'].value
    FormaPago = sheet['V10'].value
    NCuotas = sheet['W10'].value
    FormaPago2 = sheet['X10'].value
    Banco = sheet['Y10'].value
    NroCuotas = sheet['Z10'].value
    NroTarjeta = sheet['AA10'].value
    DiaPago = sheet['AB10'].value
    Minuta = sheet['AC10'].value
    TipoTarjeta = sheet['AD10'].value
    VencimientoTarjeta = sheet['AE10'].value
    Minuta = sheet['AC10'].value
    NroTelefono = sheet['AE10'].value
    Email = sheet['AI10'].value
    ...
    sleep(1)
    chrome_driver.save_screenshot('..\Screenshot\CP09\Parte01_FormularioCondominio.png')
    ...
    chrome_driver.save_screenshot('..\Screenshot\CP09\Parte02_FormularioCondominio.png')
    ...
    if (not elementMedioPago):
        chrome_driver.save_screenshot('..\Screenshot\CP09\Parte03_FormularioCondominio.png')
    ...
    chrome_driver.save_screenshot('..\Screenshot\CP09\Envio_FormularioCondominio.png')
    ...
    chrome_driver.save_screenshot('..\Screenshot\CP09\Cierre_MensajeAlerta.png')
    sleep(2)
    ...
    sleep(5)
    chrome_driver.save_screenshot('..\Screenshot\CP09\Seleccion_Plan.png')
    sleep(2)
    ...
    chrome_driver.save_screenshot('..\Screenshot\CP09\Seleccion_Plan_Incendio.png')
    sleep(2)
    ...
    sleep(1)
    chrome_driver.save_screenshot('..\Screenshot\CP09\Paso3_Parte1_CompletarDatos.png')
    sleep(1)
    ...
    sleep(1)
    chrome_driver.save_screenshot('..\Screenshot\CP09\Paso3_Parte2_CompletarDatos.png')
    sleep(1)
    ...
    chrome_driver.find_element_by_xpath('//*[@id="select2-NroCuotas-container"]').click()
    sleep(1)
    ...
    sleep(1)
    chrome_driver.save_screenshot('..\Screenshot\CP09\CalculoCuota.png')
    ...
    sleep(1)
    chrome_driver.save_screenshot('..\Screenshot\CP09\Paso3_Parte3_CompletarDatos.png')
    sleep(1)
    ...
    sleep(1)
    chrome_driver.save_screenshot('..\Screenshot\CP09\Paso3_Emitir poliza.png')
    sleep(1)
    ...
    sleep(1)
    chrome_driver.save_screenshot('..\Screenshot\CP09\PasoFinalDescarga.png')
    sleep(1)
    #Descargar poliza
    chrome_driver.find_element_by_xpath("//a[@id='btnDownloadPoliza']/span").click()
    sleep(80)
    chrome_driver.save_screenshot('..\Screenshot\CP09\ValidacionDescarga.png')
